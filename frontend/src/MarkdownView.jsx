  ...
  return (
    <div style={{ color: '#e8e8ec', lineHeight: '1.7', fontSize: '14px' }}>
      <ReactMarkdown
        ...
        components={{
          h1: ({ children }) => (
            <h2 style={{ color: '#fff', fontSize: '19px', margin: '20px 0 10px', borderBottom: '1px solid #3a3a4a', paddingBottom: '6px' }}>{children}</h2>
          ),
          h2: ({ children }) => (
            <h3 style={{ color: '#4FA3FF', fontSize: '16px', margin: '22px 0 8px', fontWeight: 600 }}>{children}</h3>
          ),
          h3: ({ children }) => (
            <h4 style={{ color: '#9BC4FF', fontSize: '14px', margin: '16px 0 6px', fontWeight: 600 }}>{children}</h4>
          ),
          ...
          th: ({ children }) => (
            <th style={{ border: '1px solid #3a3a4a', padding: '8px 10px', background: '#252532', textAlign: 'left', color: '#fff' }}>{children}</th>
          ),
